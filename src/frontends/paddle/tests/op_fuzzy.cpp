...
static const std::vector<std::string> models{
    ...
    std::string("grid_sampler_4-D_0"),
    std::string("grid_sampler_4-D_1"),
    std::string("grid_sampler_4-D_2"),
    std::string("grid_sampler_5-D_0"),
    std::string("grid_sampler_5-D_1"),
    std::string("grid_sampler_5-D_2"),
