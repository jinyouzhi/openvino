...
static const std::vector<std::string> models{
    ...
    std::string("grid_sample_4D_0"),
    std::string("grid_sample_4D_1"),
    std::string("grid_sample_4D_2"),
    std::string("grid_sample_5D_0"),
    std::string("grid_sample_5D_1"),
    std::string("grid_sample_5D_2"),
